const errorHandler = (error) => {
  ...
  const errorsDictionary = {
    400: {
      'Missed required params.': 'Не все обязательные поля заполнены',
      'The browser (or proxy) sent a request that this server could not understand.': 'Некорректный запрос'
    },
